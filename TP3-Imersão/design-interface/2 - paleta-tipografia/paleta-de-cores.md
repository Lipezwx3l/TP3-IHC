...
🎯 Motivação e Entusiasmo: Incentiva ação e engajamento

🏆 Conquista e Celebração: Representa realização e sucesso

🌅 Otimismo e Criatividade: Promove pensamento positivo
...
🎯 Sucesso e Conquista: Sinal universal de "aprovado", "correto", "completo"

🌱 Renovação e Vitalidade: Conexão com natureza, energia renovável

😌 Calma e Equilíbrio: Reduz estresse, promove tranquilidade

💚 Saúde e Bem-estar: Associado a vida, saúde e harmonia

✔️ Confirmação: "Sinal verde" = permissão para avançar

## 🎨 Paleta de Cores do Aplicativo

| Cor            | Uso / Descrição                                      | Hexadecimal |
|----------------|-------------------------------------------------------|-------------|
| **Vermelho**   | Botões, ícones e elementos de destaque                | `#E53935`   |
| **Laranja**    | Cartões Desbloqueados                                 | `#E67E4E`   |
| **Verde**      | Barra de progresso concluída                          | `#13A559`   |
| **Rosa claro** | Parte não concluída da barra de progresso             | `#F4C7CD`   |
| **Cinza claro**| Fundo de cartões bloqueados / containers neutros      | `#D3D3D3`   |
| **Cinza médio**| Textos e elementos secundários                        | `#9E9E9E`   |
