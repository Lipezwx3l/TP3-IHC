...
- Timer circular em destaque (25:00), com contorno suave que representa o tempo em progresso;

- Botão INICIAR com cor de destaque (vermelho), reforçando a ação principal;

- Indicador de Meta do dia (1/10) para gamificação e motivação;

- Barra inferior de navegação com ícones (Início, Sons, Metas).
